...
use pallet_template::DataProvider;
...
pub mod pallet {
	...
	use pallet_balances::traits::Data;
	...
	impl<T: Config> Pallet<T> {
		...
		pub fn add1(origin: OriginFor<T>, a: T:: AccountId) -> DispatchResult {
			...
			let _total_balances 
			= T::LocalCurrency::total_issuance();

			//transfer(a, who, 10000, ExistenceRequirement)
			...
			// Emit an event.
			Self::deposit_event(Event::AccountAdded{adder: who.clone(), addee: a.clone()});
